...
RSpec.describe OwnersController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the requested owner as @owner" do
      owner = Owner.create! valid_attributes
      get :edit, params: {id: owner.to_param}, session: valid_session
      expect(assigns(:owner)).to eq(owner)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Owner" do
        expect {
          post :create, params: {owner: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved owner as @owner" do
        post :create, params: {owner: invalid_attributes}, session: valid_session
        expect(assigns(:owner)).to be_a_new(Owner)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested owner" do
        owner = Owner.create! valid_attributes
        put :update, params: {id: owner.to_param, owner: new_attributes}, session: valid_session
        owner.reload
      ...
      it "assigns the requested owner as @owner" do
        owner = Owner.create! valid_attributes
        put :update, params: {id: owner.to_param, owner: valid_attributes}, session: valid_session
        expect(assigns(:owner)).to eq(owner)
      end
    ...
    context "with invalid params" do
      it "assigns the owner as @owner" do
        owner = Owner.create! valid_attributes
        put :update, params: {id: owner.to_param, owner: invalid_attributes}, session: valid_session
        expect(assigns(:owner)).to eq(owner)
      end
